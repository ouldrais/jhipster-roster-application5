...
public interface ShiftDemandRepository extends JpaRepository<ShiftDemand, Long> {
    ...
    @Query(
        value = "select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift",
    ...
    @Query("select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift")
    List<ShiftDemand> findAllWithToOneRelationships();

    @Query("select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift where shiftDemand.id =:id")
