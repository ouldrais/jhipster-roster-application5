  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.teamPlan.home.createOrEditLabel" data-cy="TeamPlanCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.teamPlan.home.createOrEditLabel">Create or edit a TeamPlan</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.teamPlan.availability')}
              ...
              <ValidatedField
                ...
                name="team"
                data-cy="team"
                label={translate('jhipsterRosterApplication5App.teamPlan.team')}
                type="select"
              >
                <option value="" key="0" />
                {teams
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('jhipsterRosterApplication5App.teamPlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
