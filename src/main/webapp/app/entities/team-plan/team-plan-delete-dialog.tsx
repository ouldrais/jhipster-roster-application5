...
export const TeamPlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.teamPlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.teamPlan.delete.question" interpolate={{ id: teamPlanEntity.id }}>
