...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.resourcePlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
