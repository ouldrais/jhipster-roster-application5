  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.resourcePlan.home.createOrEditLabel" data-cy="ResourcePlanCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.resourcePlan.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourcePlan.availability')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('jhipsterRosterApplication5App.resourcePlan.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('jhipsterRosterApplication5App.resourcePlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('jhipsterRosterApplication5App.resourcePlan.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
