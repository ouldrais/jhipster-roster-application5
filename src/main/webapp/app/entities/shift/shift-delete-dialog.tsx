...
export const ShiftDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.shift.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.shift.delete.question" interpolate={{ id: shiftEntity.id }}>
