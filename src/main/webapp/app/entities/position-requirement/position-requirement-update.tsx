  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="jhipsterRosterApplication5App.positionRequirement.home.createOrEditLabel"
            data-cy="PositionRequirementCreateUpdateHeading"
          >
            <Translate contentKey="jhipsterRosterApplication5App.positionRequirement.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.positionRequirement.mandatoty')}
              ...
              <ValidatedField
                ...
                name="training"
                data-cy="training"
                label={translate('jhipsterRosterApplication5App.positionRequirement.training')}
                type="select"
              >
                <option value="" key="0" />
                {trainings
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('jhipsterRosterApplication5App.positionRequirement.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
