...
export const PositionRequirementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.positionRequirement.delete.question">
        <Translate
          contentKey="jhipsterRosterApplication5App.positionRequirement.delete.question"
