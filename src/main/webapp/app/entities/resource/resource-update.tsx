  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resource.key')}
                id="resource-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resource.teamRole')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resource.exchangeAllowed')}
              ...
              <ValidatedField
                ...
                name="team"
                data-cy="team"
                label={translate('jhipsterRosterApplication5App.resource.team')}
                type="select"
              >
                <option value="" key="0" />
                {teams
