...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.resource.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
