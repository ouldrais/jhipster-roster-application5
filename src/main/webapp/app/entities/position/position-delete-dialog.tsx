...
export const PositionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.position.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.position.delete.question" interpolate={{ id: positionEntity.id }}>
