...
export const TeamDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.team.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.team.delete.question" interpolate={{ id: teamEntity.id }}>
