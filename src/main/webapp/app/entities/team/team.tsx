  ...
  return (
    <div>
      <h2 id="team-heading" data-cy="TeamHeading">
        <Translate contentKey="jhipsterRosterApplication5App.team.home.title">Teams</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterRosterApplication5App.team.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/team/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterRosterApplication5App.team.home.createLabel">Create new Team</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teamList && teamList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterRosterApplication5App.team.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="jhipsterRosterApplication5App.team.key">Key</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterRosterApplication5App.team.home.notFound">No Teams found</Translate>
            </div>
          )
        )}
      </div>
