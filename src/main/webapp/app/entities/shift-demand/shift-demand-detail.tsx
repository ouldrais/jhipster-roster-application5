    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shiftDemandDetailsHeading">
          <Translate contentKey="jhipsterRosterApplication5App.shiftDemand.detail.title">ShiftDemand</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterRosterApplication5App.shiftDemand.shift">Shift</Translate>
          </dt>
          ...
          <dd>{shiftDemandEntity.department ? shiftDemandEntity.department.id : ''}</dd>
        </dl>
