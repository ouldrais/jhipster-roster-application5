  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.shiftDemand.home.createOrEditLabel" data-cy="ShiftDemandCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.shiftDemand.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.shiftDemand.count')}
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('jhipsterRosterApplication5App.shiftDemand.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterRosterApplication5App.shiftDemand.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
