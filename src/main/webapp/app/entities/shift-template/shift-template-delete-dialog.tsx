...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication5App.shiftTemplate.delete.question">
        <Translate contentKey="jhipsterRosterApplication5App.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
