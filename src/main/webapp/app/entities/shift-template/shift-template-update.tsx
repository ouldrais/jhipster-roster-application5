  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.shiftTemplate.home.createOrEditLabel" data-cy="ShiftTemplateCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.shiftTemplate.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.shiftTemplate.key')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.shiftTemplate.shiftStart')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.shiftTemplate.shiftEnd')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.shiftTemplate.type')}
