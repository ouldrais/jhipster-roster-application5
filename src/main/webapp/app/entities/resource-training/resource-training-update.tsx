  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication5App.resourceTraining.home.createOrEditLabel" data-cy="ResourceTrainingCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication5App.resourceTraining.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourceTraining.status')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourceTraining.level')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourceTraining.trainer')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourceTraining.activeFrom')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication5App.resourceTraining.activeto')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('jhipsterRosterApplication5App.resourceTraining.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="training"
                data-cy="training"
                label={translate('jhipsterRosterApplication5App.resourceTraining.training')}
                type="select"
              >
                <option value="" key="0" />
                {trainings
